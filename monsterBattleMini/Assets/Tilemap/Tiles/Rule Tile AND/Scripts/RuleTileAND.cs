...
namespace UnityEngine
{
	[Serializable]
	[CreateAssetMenu]
	public class RuleTileAND : TileBase
	{
		...
		public class TilingRule
		{
            ...
            public bool m_showSpriteToCheck = false;
            public Sprite m_neighborSpriteToCheck;
			...
			public enum Neighbor { DontCare, This, NotThis, ThisPlus }
